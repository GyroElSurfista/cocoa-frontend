...
interface ObjectiveTrackerProps {
  objective: Objective
  onPlanillaClick: (planilla: rowTracker) => void // Nuevo prop para manejar clics en planillas
}

const SelectorObjectiveTracker: React.FC<ObjectiveTrackerProps> = ({ objective, onPlanillaClick }) => {
        ...
        <div className="py-4 px-20 text-gray-600">
          {rowsTracker?.map((row, index) => (
            <div
              ...
              onClick={() => onPlanillaClick(row)} // Al hacer clic, pasamos los datos de la planilla
            >
...
export default SelectorObjectiveTracker
