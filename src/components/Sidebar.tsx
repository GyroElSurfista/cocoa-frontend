      ...
      >
        ...
        <nav className={`${isOpen ? 'block' : 'hidden'} pl-16 pt-8`}>
          ...
          <div className="flex flex-col mt-9">
            {currentSemester ? (
              <>
                {currentDay.isAfter(currentSemester.fechaPlaniInici) && currentDay.isBefore(currentSemester.fechaEvaluInici) && (
                  <ItemSidebar name="Registrar y Añadir">
                    <>
                      {currentDay.isAfter(currentSemester.fechaPlaniInici) && currentDay.isBefore(currentSemester.fechaPlaniFin) && (
                        <>
                          <NavLink
                            to="/objetivos"
                            className={({ isActive }) =>
                      ...
                      {currentDay.isAfter(currentSemester.fechaPlaniInici) && currentDay.isBefore(currentSemester.fechaDesaFin) && (
                        <NavLink
                          to="/crear-actividad"
                          className={({ isActive }) =>
                            `hover:text-[#6344e7] py-3 px-2.5 text-base font-normal gap-1 items-center flex ${isActive ? 'bg-[#e0e3ff] text-[#6344e7] border-l-2 border-[#6344e7]' : ''}`
                ...
                <ItemSidebar name="Generar y Crear">
                  <>
                    {currentDay.isAfter(currentSemester.fechaDesaInici) && currentDay.isBefore(currentSemester.fechaDesaFin) && (
                      <>
